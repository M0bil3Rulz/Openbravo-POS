...
public class JTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    public Object createValue() throws BasicException {
        ...
        if (jComboBoxTicket.getSelectedIndex() == 2) {
            afilter[4] = QBFCompareEnum.COMP_DISTINCT;
            afilter[5] = 2;
        ...
        // Receipt money
        afilter[7] = jtxtMoney.getDoubleValue();
        afilter[6] = afilter[7] == null ? QBFCompareEnum.COMP_NONE : jcboMoney.getSelectedItem();
        ...
        afilter[8] = (startdate == null) ? QBFCompareEnum.COMP_NONE : QBFCompareEnum.COMP_GREATEROREQUALS;
        afilter[9] = startdate;
        afilter[10] = (enddate == null) ? QBFCompareEnum.COMP_NONE : QBFCompareEnum.COMP_LESS;
        afilter[11] = enddate;
        ...
        if (jcboUser.getSelectedItem() == null) {
            ...
            afilter[13] = ((TaxCategoryInfo)jcboUser.getSelectedItem()).getName(); 
        }
        ...
        if (jtxtCustomer.getText() == null || jtxtCustomer.getText().equals("")) {
            ...
            afilter[15] = "%" + jtxtCustomer.getText() + "%";
        }
