...
public class TicketInfo implements SerializableRead, Externalizable {
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        m_iTableId = dr.getInt(4).intValue(); // AK - incremented numbers after this as well.
        m_dDate = dr.getTimestamp(5);
        m_sActiveCash = dr.getString(6);
        try {
        ...
        m_Customer = new CustomerInfoExt(dr.getString(10));
    ...
    // AK
    public String printTableId() {
        if (m_iTableId > 0) {
            // valid ticket id
            return Formats.INT.formatValue(new Integer(m_iTableId));
        } else {
            return " No Table Specified"; // AK
        }
    }
